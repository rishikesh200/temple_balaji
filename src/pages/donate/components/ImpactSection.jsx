  ...
  return (
    <section className="py-16 md:py-24 bg-gray-warm-light parchment-bg relative overflow-hidden animate-fade-in" id="impact">
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        {/* Impact Cards Grid */}
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12">

          {/* Card 1: Community Support */}
          <StaggerItem className="bg-white rounded-3xl p-8 shadow-xs border border-border-warm text-center relative group hover:border-gold/60 hover:shadow-md transition-all duration-300">
