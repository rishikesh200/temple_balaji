              ...
              <div className="relative pl-6 border-l-2 border-gold/40 space-y-6 ml-2">
                {formattedBenefits.map((benefit, idx) => (
                  <div key={idx} className="relative group">
                    <span className="absolute -left-[31px] top-0 w-5 h-5 rounded-full bg-maroon border-2 border-gold flex items-center justify-center text-[9px] font-bold text-white shadow-xs group-hover:scale-110 transition-transform">
                      {idx + 1}
                    </span>
                    <div>
