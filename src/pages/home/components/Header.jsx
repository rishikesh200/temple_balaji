        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 ml-4">
              <a href="#" className="hover:text-[#D4A853]">
          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              <NavLink
                ...
                className={({ isActive }) =>
                  `font-medium text-sm ${isActive ? "text-[#8B1A1A]" : "text-[#2D1810] hover:text-[#8B1A1A]"}`
                }
              >
                Home
              </NavLink>
          ...
          {mobileMenuOpen && (
            <nav className="lg:hidden mt-4 py-4 border-t border-[#E5D5C5]">
              <div className="flex flex-col gap-3">
                <Link to="/" className="text-[#2D1810] font-medium py-2">
                  Home
                </Link>
                <Link to="/about" className="text-[#2D1810] font-medium py-2">
                  About Us
                </Link>
                ...
                <Link to="/donate" className="text-[#2D1810] font-medium py-2">
                  Donate
                </Link>
                <Link to="/gallery" className="text-[#2D1810] font-medium py-2">
                  Gallery
                </Link>
                <Link to="/store" className="text-[#2D1810] font-medium py-2">
                  Store
                </Link>
                <Link to="/contact" className="text-[#2D1810] font-medium py-2">
                  Contact Us
                </Link>
                <Link
                  to="/donate"
