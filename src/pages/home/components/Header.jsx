...
export default function Header() {
  ...
  // central nav items to keep desktop and mobile in sync
  const navItems = [
    { label: "Home", to: "/" },
    { label: "Darshans", to: "/darshan" },
    { label: "Poojas", to: "/pooja" },
        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 ml-4">
              ...
              <a href="#" className="hover:text-[#D4A853]">{/* youtube */}
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-col gap-3">
                {navItems.map((item) => (
                  <NavLink
                    ...
                    className={({ isActive }) => `text-[#2D1810] font-medium py-2 ${isActive ? 'text-[#8B1A1A]' : ''}`}
                  >
                    {item.label}
                  </NavLink>
                ))}

                <NavLink to="/donate" className="text-[#2D1810] font-medium py-2">
                  Donate
                </NavLink>

                <NavLink to="/store" className="text-[#2D1810] font-medium py-2">
                  Store
                </NavLink>
