...
function IconRing({ children, className = "" }) {
  return (
    <div
      className={`flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full border-2 ${className}`}
      style={{ borderColor: goldRing, backgroundColor: cream }}
    >
      {children}
    </div>
  )
  ...
  return (
    <section className="py-12 md:py-14" style={{ backgroundColor: cream }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <StaggerContainer className="grid grid-cols-1 divide-y divide-border-warm md:grid-cols-3 md:divide-x md:divide-y-0 md:divide-border-warm">
          {/* Column 1 */}
          <StaggerItem className="flex items-start gap-4 py-8 md:py-2 md:pr-8 md:pl-2 lg:pr-10">
            <IconRing>
          ...
          {/* Column 2 */}
          <StaggerItem className="flex items-start gap-4 py-8 md:py-2 md:px-6 lg:px-10">
            <div
          ...
          {/* Column 3 */}
          <StaggerItem className="flex items-start gap-4 py-8 md:py-2 md:pl-8 md:pr-2 lg:pl-10">
            <IconRing>
              <Landmark className="h-7 w-7" strokeWidth={2} style={{ color: maroon }} />
            </IconRing>
            <div className="min-w-0">
              <h3
                className="mb-1.5 font-serif text-lg font-bold leading-snug md:text-[1.05rem] lg:text-lg"
              ...
              <p className="mb-4 text-sm leading-relaxed" style={{ color: bodyGrey }}>
                Stay updated with the latest events, poojas and temple darshans.
              </p>
