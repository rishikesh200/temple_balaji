    ...
    <section className="py-8 bg-[#FDF8F3]">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/events"
            className="text-sm text-[#8B1A1A] border border-[#8B1A1A] px-4 py-1.5 rounded-md hover:bg-[#8B1A1A] hover:text-white transition-colors">
            {TRANSLATIONS.viewAllEvents[lang]}
          </Link>
        </div>

        <div className="relative -mx-4 md:mx-0 overflow-x-hidden overflow-y-hidden">
          <Marquee pauseOnHover speed={35} gradient gradientColor="#FDF8F3" gradientWidth={72} className="py-1 overflow-y-hidden">
              ...
              return (
                <div key={event.id}
                  ...
                  <div className="min-w-0 pr-1">
                    <h3 className="font-semibold text-base text-[#2D1810] leading-snug">{getT(event, 'title', lang)}</h3>
