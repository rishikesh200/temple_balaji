...
export default function BookingSection({ selectedType, onSelectType }) {
  ...
  return (
    <section className="py-16 md:py-24 bg-[#F6F3F2] relative overflow-hidden" id="darshan-booking-section">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl border border-[#E5D5C5] p-6 md:p-8 shadow-xl relative overflow-hidden ring-1 ring-[#D4A853]/25">
            ...
            <div className="flex items-center justify-between mb-8 border-b border-[#F5E6D3] pb-4">
              <div className="flex items-center gap-2">
                ...
                <span className={`text-xs font-bold ${step === 1 ? "text-[#8B1A1A]" : "text-green-600"}`}>Darshan & Slot</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`text-xs font-bold ${step === 2 ? "text-[#8B1A1A]" : "text-[#6B4423]"}`}>Devotees & Verification</span>
              </div>
            </div>
            ...
            {step === 1 && (
              <div className="space-y-6 animate-fade-in">
                ...
                <div>
                  <label className="block text-xs font-bold text-[#2D1810] mb-3 uppercase tracking-wider flex items-center gap-1.5">
                    <Sparkles className="w-4 h-4 text-[#8B1A1A]" /> 1. Select Darshan Type *
                  </label>
                      ...
                      >
                        <div>
                          <span className={`text-[10px] font-bold uppercase tracking-wider block mb-1 ${
                            selectedType === type.id ? "text-[#D4A853]" : "text-[#8B1A1A]"
                          }`}>
                            {type.tagline}
                          </span>
                ...
                {/* 2. Choose Date */}
                <div>
                  <label className="block text-xs font-bold text-[#2D1810] mb-2 uppercase tracking-wider flex items-center gap-1.5">
                    <Calendar className="w-4 h-4 text-[#8B1A1A]" /> 2. Choose Visit Date *
                  </label>
                  <input
                    type="date"
                    value={date}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#2D1810] mb-3 uppercase tracking-wider flex items-center gap-1.5">
                    <Clock className="w-4 h-4 text-[#8B1A1A]" /> 3. Select Queue Timing Slot *
                  </label>
                ...
                <button
                  ...
                  className="w-full bg-[#8B1A1A] text-white py-3.5 rounded-xl font-bold text-sm border border-[#D4A853] shadow-md hover:bg-[#6B1414] hover:translate-x-0.5 transition-all flex items-center justify-center gap-2 cursor-pointer mt-4"
                >
            ...
            {step === 2 && (
              <form onSubmit={handleBookingSubmit} className="space-y-4 animate-fade-in">
                ...
                <div className="flex items-center justify-between border-b border-[#F5E6D3] pb-2">
                  <h4 className="font-serif text-lg font-bold text-[#2D1810]">Devotee Verification Info</h4>
                  <button
                    type="button"
                    onClick={() => setStep(1)}
                ...
                <div>
                  <label className="block text-xs font-bold text-[#2D1810] mb-2 flex items-center gap-1">
                    <Users className="w-4.5 h-4.5 text-[#8B1A1A]" /> Total Devotees count (Maximum 5 per booking) *
                  </label>
                  <div className="flex items-center gap-2">
                    {[1, 2, 3, 4, 5].map((cnt) => (
                      <button
                        ...
                        className={`flex-1 py-2 text-sm font-bold rounded-lg border transition-all ${
                          devoteesCount === cnt
                            ? "bg-[#8B1A1A] text-white border-[#8B1A1A] ring-2 ring-[#D4A853]"
                            : "bg-[#FDF8F3] text-[#2D1810] border-[#E5D5C5] hover:border-[#8B1A1A]"
                        }`}
                      >
                        {cnt}
                      </button>
                ...
                <div className="space-y-3.5">
                  ...
                  {/* Name */}
                  <div>
                    <label className="block text-xs font-bold text-[#2D1810] mb-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-2.5 rounded-xl border ${errors.name ? "border-red-500 bg-red-50/10" : "border-[#E5D5C5] focus:border-[#8B1A1A]"} bg-[#FDF8F3]/50 focus:outline-none transition-all text-[#2D1810] text-sm`}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-2.5 rounded-xl border ${errors.phone ? "border-red-500 bg-red-50/10" : "border-[#E5D5C5] focus:border-[#8B1A1A]"} bg-[#FDF8F3]/50 focus:outline-none transition-all text-[#2D1810] text-sm`}
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-2.5 rounded-xl border ${errors.email ? "border-red-500 bg-red-50/10" : "border-[#E5D5C5] focus:border-[#8B1A1A]"} bg-[#FDF8F3]/50 focus:outline-none transition-all text-[#2D1810] text-sm`}
                        />
                      </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        className={`w-full pl-10 pr-4 py-2 rounded-xl border ${errors.address ? "border-red-500 bg-red-50/10" : "border-[#E5D5C5] focus:border-[#8B1A1A]"} bg-[#FDF8F3]/50 focus:outline-none transition-all text-[#2D1810] text-sm resize-none`}
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-[#FDF8F3] p-4 rounded-2xl border border-[#E5D5C5]/80">
                    <div>
                      <label className="block text-xs font-bold text-[#2D1810] mb-1.5 flex items-center gap-1">
                        <IdCard className="w-4 h-4 text-[#8B1A1A]" /> Verification ID Type *
                      </label>
                      <select
                        value={idType}
                        onChange={(e) => setIdType(e.target.value)}
                        className="w-full px-3 py-2 rounded-xl border border-[#E5D5C5] focus:border-[#8B1A1A] bg-white text-xs font-bold text-[#2D1810] focus:outline-none"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 rounded-xl border ${errors.idNumber ? "border-red-500" : "border-[#E5D5C5] focus:border-[#8B1A1A]"} bg-white focus:outline-none text-xs font-medium text-[#2D1810]`}
                      />
                ...
                <div className="p-4 bg-[#FDF8F3] rounded-2xl border border-[#E5D5C5] space-y-2 mt-4">
                  <span className="text-[10px] font-bold text-[#8B1A1A] uppercase tracking-wider block border-b border-[#E5D5C5] pb-1">Darshan Pass Calculations</span>
                  <div className="flex justify-between text-xs text-[#6B4423] font-medium">
                    <span>Darshan Category:</span>
                    <span className="font-bold text-[#2D1810]">{currentDarshan.title}</span>
                  </div>
                  <div className="flex justify-between text-xs text-[#6B4423] font-medium">
                  ...
                  <div className="flex justify-between text-xs text-[#6B4423] font-medium">
                    ...
                    <span className="font-bold text-[#2D1810] font-mono">{devoteesCount} Devotees</span>
                  </div>
                  <div className="flex justify-between text-sm text-[#2D1810] font-bold border-t border-[#E5D5C5] pt-2 mt-1">
                    <span className="flex items-center gap-1"><ShieldCheck className="w-4.5 h-4.5 text-[#8B1A1A]" /> Net Payable Amount:</span>
                    <span className="font-serif text-[#8B1A1A] text-lg font-mono">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    onClick={() => setStep(1)}
                    className="w-1/3 bg-[#FDF8F3] border border-[#E5D5C5] text-[#2D1810] py-3 rounded-xl font-bold text-xs hover:bg-gray-50 flex items-center justify-center gap-1 shadow-xs transition-colors cursor-pointer"
                  >
                    Back
                  </button>
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className={`w-2/3 bg-[#8B1A1A] text-white py-3 rounded-xl font-bold text-xs border border-[#D4A853] shadow-md hover:bg-[#6B1414] hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer ${isSubmitting ? "opacity-75 cursor-not-allowed" : ""}`}
                  >
                    {isSubmitting ? (
                      <>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-[#E5D5C5] flex flex-col relative overflow-hidden">
              <div className="absolute top-0 left-0 w-2 h-full bg-[#8B1A1A]" />
              <div className="w-10 h-10 bg-[#ffdad4]/80 flex items-center justify-center rounded-full mb-4">
                <Clock className="w-5 h-5 text-[#8B1A1A]" />
              </div>
              <h3 className="font-serif text-lg font-bold text-[#2D1810] mb-3">Best Times to Visit</h3>
              <ul className="space-y-3.5 text-xs text-[#6B4423] font-medium">
                <li className="flex items-start gap-2.5">
                  <span className="text-[#D4A853] font-bold mt-0.5">•</span>
                  <span>
                    <strong className="text-[#2D1810]">Quiet Hours:</strong> Weekdays between 10:00 AM and 4:00 PM are generally peaceful and experience minimal queue waiting times.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-[#D4A853] font-bold mt-0.5">•</span>
                  <span>
                    <strong className="text-[#2D1810]">Peak Hours:</strong> Weekends, government holidays, and early mornings (6:00 AM - 9:00 AM) see large footfalls.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-[#D4A853] font-bold mt-0.5">•</span>
                  <span>
                    <strong className="text-[#2D1810]">Evening Grace:</strong> Evening Maha Arathi performed daily at 7:00 PM provides an immersive, spiritual temple experience.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-[#E5D5C5] flex flex-col relative overflow-hidden">
              <div className="absolute top-0 left-0 w-2 h-full bg-[#D4A853]" />
              <div className="w-10 h-10 bg-[#FDF8F3] flex items-center justify-center rounded-full mb-4 border border-[#E5D5C5]">
                <Bus className="w-5 h-5 text-[#D4A853]" />
              </div>
              <h3 className="font-serif text-lg font-bold text-[#2D1810] mb-3">Travel & Connectivity</h3>
              <div className="space-y-3 text-xs text-[#6B4423] font-medium">
                <p>
                  <strong className="text-[#2D1810]">Public Buses:</strong> High frequency direct buses are accessible from Avadi Bus Depot and Poonamallee Junction. Nearest local train station is Avadi.
                </p>
                <p>
                  <strong className="text-[#2D1810]">Private Vehicles:</strong> Spacious and secure parking zones are available inside the temple gate, completely free of cost for visiting pilgrims.
                </p>
                <div className="pt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 text-[#8B1A1A] font-bold hover:underline"
                  >
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-[#E5D5C5] flex flex-col relative overflow-hidden">
              <div className="absolute top-0 left-0 w-2 h-full bg-[#6B4423]" />
              <div className="w-10 h-10 bg-gray-100 flex items-center justify-center rounded-full mb-4">
                <PartyPopper className="w-5 h-5 text-[#6B4423]" />
              </div>
              <h3 className="font-serif text-lg font-bold text-[#2D1810] mb-3">Important Annual Festivals</h3>
              <ul className="space-y-3.5 text-xs font-semibold">
                <li className="flex items-center justify-between border-b border-[#E5D5C5]/40 pb-2">
                  <span className="text-[#2D1810]">Brahmotsavam Festival</span>
                  <span className="text-[#8B1A1A] text-[10px] font-bold uppercase">Oct 12 - Oct 20</span>
                </li>
                <li className="flex items-center justify-between border-b border-[#E5D5C5]/40 pb-2">
                  <span className="text-[#2D1810]">Vaikunta Ekadasi</span>
                  <span className="text-[#8B1A1A] text-[10px] font-bold uppercase">Dec 23</span>
                </li>
                <li className="flex items-center justify-between border-b border-[#E5D5C5]/40 pb-2">
                  <span className="text-[#2D1810]">New Year Special Arati</span>
                  <span className="text-[#8B1A1A] text-[10px] font-bold uppercase">Jan 01</span>
                </li>
                <li className="flex items-center justify-between">
                  <span className="text-[#2D1810]">Monthly Sravanam Alankaram</span>
                  <span className="text-[#8B1A1A] text-[10px] font-bold uppercase">Monthly</span>
                </li>
              </ul>
            </div>
      ...
      {bookingSuccess && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/75 backdrop-blur-xs animate-fade-in">
          <div className="bg-white rounded-3xl max-w-lg w-full overflow-hidden border-2 border-[#D4A853] shadow-2xl relative animate-scale-up max-h-[90vh] flex flex-col">
            ...
            {/* Ticket Content */}
            <div className="p-6 overflow-y-auto space-y-5 flex-grow bg-[#FDF8F3]/50">
              ...
              <div className="flex items-center justify-between bg-white border border-[#E5D5C5] p-3.5 rounded-2xl shadow-2xs">
                <div>
                  <span className="text-[10px] text-[#6B4423] font-bold uppercase tracking-wider block">Pass Reference</span>
                  <span className="font-mono text-sm font-bold text-[#8B1A1A]">{bookingRef}</span>
                </div>
                <div className="text-right">
                  <span className="text-[10px] text-[#6B4423] font-bold uppercase tracking-wider block">Darshan Status</span>
              ...
              <div className="bg-white p-4 rounded-2xl border border-[#E5D5C5] space-y-2.5 shadow-2xs">
                <h4 className="font-serif text-sm font-bold text-[#2D1810] border-b border-[#F5E6D3] pb-1.5 flex items-center gap-1.5">
                  <Sparkles className="w-4 h-4 text-[#D4A853]" /> Scheduled Entry Details
                </h4>
                <div className="grid grid-cols-2 gap-y-3 gap-x-2 text-xs text-[#6B4423]">
                  <div>
                    ...
                    <span className="font-bold text-[#8B1A1A]">{currentDarshan.title}</span>
                  </div>
                  <div>
              ...
              <div className="bg-white p-4 rounded-2xl border border-[#E5D5C5] space-y-2.5 shadow-2xs">
                <h4 className="font-serif text-sm font-bold text-[#2D1810] border-b border-[#F5E6D3] pb-1.5 flex items-center gap-1.5">
                  <User className="w-4 h-4 text-[#D4A853]" /> Registered Pilgrims
                </h4>
                <div className="grid grid-cols-2 gap-y-3 gap-x-2 text-xs text-[#6B4423]">
                  <div>
                  ...
                  <div>
                    ...
                    <span className="font-bold text-[#8B1A1A] font-mono">{devoteesCount} Devotees</span>
                  </div>
                  <div>
              ...
              {/* Instructions banner */}
              <div className="p-3 bg-amber-50 border border-amber-200 rounded-2xl text-[#8B1A1A] text-[10.5px] leading-relaxed font-medium">
            ...
            <div className="bg-[#8B1A1A]/5 border-t-2 border-dashed border-[#D4A853] p-5 flex gap-3">
              <button
                ...
                className="flex-1 bg-white border border-[#E5D5C5] text-[#2D1810] py-3.5 rounded-xl font-bold text-xs hover:bg-gray-50 flex items-center justify-center gap-2 shadow-xs transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="flex-1 bg-[#8B1A1A] text-white py-3.5 rounded-xl font-bold text-xs border border-[#D4A853] hover:bg-[#6B1414] flex items-center justify-center gap-2 shadow-xs transition-colors cursor-pointer"
              >
                Done & Continue
              </button>
            </div>
